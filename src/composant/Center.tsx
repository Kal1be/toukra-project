  ...
  return (
    <div className="bg-white md:-mt-36 mt-10 md:px-12 px-4">
        ...
        <div className="md:flex justify-between w-sreen">
            ...
            <h6 className="text-sky-400 xl:text-4xl text-xl font-bold lg:mt-6 mt-2">50ans d'expertiste et d'experience</h6>
             <motion.p
            ...
            <h6 className="mt-2 font-bold md:text-2xl text-lg my-3"><FontAwesomeIcon icon={faPhone} className="text-sky-400"/> contact: <span className="text-xl font-sm">+235 66 93 93 77 </span> </h6>
