...
function Footer() {
  return (
    <div className="bg-black w-full static">
    <div className="  md:flex justify-between md:px-16 px-4 py-4" id="footer">
      ...
      <div className="flex items-center">
       ...
       <div>
       <h3 className="lg:text-2xl md:mt-[-1px] text-gray-300 text-xl font-extrabold">Universite de<span className="text-sky-400"> Toukra</span></h3>
       <div className="divider  -ms-1 -mt-1">
       <img src="/toukra-project/drapeau1.png" alt="" className="xl:w-2 xl:h-3 w-2 h-3" />
       </div>
       </div>
      </div>
      <p>Batîment du Senat, Universitè de <br /> Ndjamèna, Campus de Toukra, Ndjamena Tchad.</p>
      </div>
      {/* ________________+++++++++++++++++++================= the main _______++++++++++++++++++++++++++========================== */}
      <div>
        <h2 className="text-gray-300">installations et services</h2>
        <ul>
      ...
      <div>
        <h2 className="text-gray-300">Autres liens</h2>
        <ul>
      ...
      <div>
       <h2 className="text-gray-300">Facultes & Departements</h2>
       <ul>
    ...
    <div id="lastf">
      <div className="flex items-center md:gap-6 gap-5">
        <h2 className="text-gray-200" >Suivez nous sur:</h2>
    ...
    <p>Powered by <Link to="/toukra-project/devsoftware" className="text-sky-400 underline">DevSoftware Yahoulbo &copy;2023</Link></p>
    </div>
    </div>
    </div>
  )
