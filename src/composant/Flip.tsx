...
function Flip() {
  ...
  return (
    <div className=" bg-sky-400 mt-4 pb-12 pt-6">
      <div className=" md:flex md:mx-28 p-4 py-4">
        ...
        <h3 className="md:text-4xl text-2xl  text-white font-extrabold">L'universite de Toukra </h3>
         <p className="text-xl text-gray-200 my-3 mx-1">L'universite de Toukra est une universite qui fait de l'apprentissage son credo et sa renommee.</p>
         <button className="bg-black text-white p-3">Decouvrir l'universite <FontAwesomeIcon icon={faArrowRight}/></button>
        </div>

        {/* ++++++++++++++++======================the temoignages of our student++++++++++================================== */}

        <div className="md:w-[500px] my-4 md:my-0 ">
        <h4 className=" text-white font-extrabold md:text-3xl mx-4 text-xl text-center md:text-left">Reportages de nos Etudiants</h4>
        <Carousel 
  ...
  <div className="flip-card-inner  rounded-2  shadow">
    ...
    <h2>Developpement</h2>
      <p>Etudiez a l'universite de Toukra c'est choisir d'etre intellectuel ?
        ...
        aussi des intellectuels internationale qui sont repartis dans toutes les coins du monde.
      </p>
    </div>
    <div className="flip-card-back  rounded-2 ">
